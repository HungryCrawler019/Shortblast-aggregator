...
export type SolanaProgram = {
  address: 'SB8MfsHPFZEicQ4jdWkcgd4YeAenwkaN1j19PKnw86R';
  metadata: {
    name: 'solanaProgram';
    version: '0.1.0';
    spec: '0.1.0';
  ...
  instructions: [
    ...
    {
      name: 'createShortPool';
      discriminator: [61, 127, 87, 9, 0, 180, 75, 130];
      accounts: [
        {
          name: 'pool';
          writable: true;
  ...
  accounts: [
    ...
    {
      name: 'shortPool';
      discriminator: [95, 138, 164, 245, 252, 158, 238, 131];
    },
  ];
  events: [
    {
      name: 'purchaseEvent';
      discriminator: [229, 118, 246, 164, 59, 65, 116, 254];
    },
  ];
  errors: [
    {
